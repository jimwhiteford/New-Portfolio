      ...
      {pinnedItems.map((data: any) => {
        return (
          <div className="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
              <img
                className="object-fill h-80 w-full rounded-t-lg"
            ...
            <div className="p-5">
              ...
              <div className="flex justify-between">
                ...
                <div className="mt-5">
                  <a
                    href="#"
                    className="inline-flex py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    See Live Site
                    <svg
                      aria-hidden="true"
